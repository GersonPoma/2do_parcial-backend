...
class Command(BaseCommand):
    help = 'Genera actividades y calificaciones simuladas para los 3 trimestres de la gestión 2023 con notas desde 30%'
    ...
    def handle(self, *args, **kwargs):
        ...
        for curso_id, materia_id, profesor_id in grupos:
            ...
            for trimestre, fecha_entrega in fechas_trimestre.items():
                for dimension in dimensiones:
                    ...
                    for n in range(1, cantidad + 1):
                        ...
                        for alumno in alumnos:
                            nota = round(random.uniform(maximo * 0.30, maximo), 2)
                            estado = AlumnoActividad.ENTREGADO
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Se generaron {total_actividades} actividades y {total_notas} calificaciones para los 3 trimestres de 2023."
        ))
