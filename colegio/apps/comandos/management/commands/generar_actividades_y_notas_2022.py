...
class Command(BaseCommand):
    help = 'Genera actividades y calificaciones simuladas para los 3 trimestres del año 2022'
    ...
    def handle(self, *args, **kwargs):
                ...
                for dimension in dimensiones:
                    ...
                    for n in range(1, cantidad + 1):
                        ...
                        for alumno in alumnos:
                            nota = round(random.uniform(maximo * 0.51, maximo), 2)
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Se generaron {total_actividades} actividades y {total_notas} calificaciones para los 3 trimestres de 2022."
        ))