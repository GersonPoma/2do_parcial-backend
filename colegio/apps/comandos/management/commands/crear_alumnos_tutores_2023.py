...
class Command(BaseCommand):
    help = 'Crear alumnos promovidos y nuevos para 2023'
    ...
    def handle(self, *args, **kwargs):
        ...
        niveles_2022 = ['1ro', '2do', '3ro']
        niveles_2023 = {'1ro': '2do', '2do': '3ro', '3ro': '4to'}
        paralelos = ['A', 'B', 'C']
        gestion_nueva = 2023
        total_nuevos = 0
        total_promovidos = 0

        # 👉 PROMOVER alumnos del 2022 a un nivel superior en 2023
        for nivel_2022 in niveles_2022:
            nivel_2023 = niveles_2023[nivel_2022]
            for paralelo in paralelos:
                curso_anterior = Curso.objects.get(nivel=nivel_2022, paralelo=paralelo)
                curso_nuevo = Curso.objects.get(nivel=nivel_2023, paralelo=paralelo)

                alumnos_2022 = AlumnoCurso.objects.filter(gestion=2022, id_curso=curso_anterior)

                for registro in alumnos_2022:
        ...
        # 👉 CREAR 60 NUEVOS alumnos con sus tutores para 1ro A/B/C en 2023
        ...
        password_alumno = 'Alumno2023'
        password_tutor = 'Tutor2023'
        ...
        for paralelo in paralelos:
            ...
            for _ in range(20):
                ...
                fecha_nac_alumno = date(2011, randint(1, 12), randint(1, 28))  # Aprox. 12 años en 2023
